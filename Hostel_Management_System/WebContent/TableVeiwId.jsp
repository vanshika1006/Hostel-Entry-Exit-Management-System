...
<head>
    ...
    <title>Records for Student ID</title>
...
<div class="container">
    <h2 class="text-center mt-3 mb-3">Student Entry-Exit Record</h2>
    ...
    <c:if test="${empty records}">
        <p class="text-center no-records-message">No record available for the specified student ID.</p>
    </c:if>
